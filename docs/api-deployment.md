...
release tag. Probe-identity replies and bounces route directly to the Google
Workspace catch-all documented in `docs/probe-sender-catchall.md`; this host
does not accept inbound SMTP.
...
must identify the API and worker images. Compose explicitly allows the sole
