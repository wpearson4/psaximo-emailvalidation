...
internal static class ResultFormatter
{
    ...
    private static string ToText(EmailValidationResult result)
    {
        ...
        Add(builder, "Confidence:", result.Confidence.ToString("P0", CultureInfo.InvariantCulture));
