...
public sealed class CsvFileProcessorTests
{
    ...
    public async Task Processing_AddsResultColumns_PreservesOrderUnicodeAndQuotesReason()
    {
        ...
        Assert.StartsWith("\uFEFFName,Business Email,Note,Status,Classification Confidence,Confidence Reason,Unknown Cause,Unknown Summary,Unknown Retryable,Recommended Action,Evidence Quality", output, StringComparison.Ordinal);
